...
!function (e, t) {
          ...
          return 1 === h && 0 === g ? function (e) {
            ...
            if (c) {
              ...
              if (u = [v ? c.firstChild : c.lastChild], v && p) {
                for (a = (r = (i = c[x] || (c[x] = {}))[d] || [])[0] === N && r[1], s = r[0] === N && r[2], o = a && c.childNodes[a]; o = ++a && o && o[l] || (s = a = 0) || u.pop();) if (1 === o.nodeType && ++s && o === e) {
                  i[d] = [N, a, s];
                  break;
                }
              } else if (p && (r = (e[x] || (e[x] = {}))[d]) && r[0] === N) s = r[1];else for (; (o = ++a && o && o[l] || (s = a = 0) || u.pop()) && ((y ? o.nodeName.toLowerCase() !== f : 1 !== o.nodeType) || !++s || (p && ((o[x] || (o[x] = {}))[d] = [N, s]), o !== e)););
  ...
  var H = w.access = function (e, t, n, r, i, o, s) {
    var a = 0,
        u = e.length,
        l = null == n;
    if ("object" === w.type(n)) for (a in i = !0, n) w.access(e, t, a, n[a], !0, o, s);else if (void 0 !== r && (i = !0, w.isFunction(r) || (s = !0), l && (t = s ? (t.call(e, r), null) : (l = t, function (e, t, n) {
      return l.call(w(e), n);
...
window.Modernizr = function (i, l, a) {
  ...
  function s(e, t) {
    for (var n in e) if (m[e[n]] !== a) return "pfx" != t || e[n];
  ...
  function o(e, t, n, r) {
    ...
    if (parseInt(n, 10)) for (; n--;) (i = l.createElement("div")).id = r ? r[n] : p + (n + 1), a.appendChild(i);
    return o = ["&#173;", "<style>", e, "</style>"].join(""), a.id = p, s.innerHTML += o, s.appendChild(a), c || f.appendChild(s), e = t(a, e), c ? a.parentNode.removeChild(a) : s.parentNode.removeChild(s), !!e;
  }
  ...
  var e,
      ...
      f = l.documentElement,
      p = "modernizr",
      m = l.createElement(p).style,
      h = l.createElement("input"),
      g = ":)",
      v = {}.toString,
    ...
    t = t || l.createElement(u[e] || "div");
    var n = ((e = "on" + e) in t);
    return n || (t.setAttribute || (t = l.createElement("div")), t.setAttribute && t.removeAttribute && (t.setAttribute(e, ""), n = c(t[e], "function"), void 0 === t[e] || (t[e] = a), t.removeAttribute(e))), t = null, n;
  }),
      M = {}.hasOwnProperty,
  ...
  Function.prototype.bind || (Function.prototype.bind = function (n) {
    ...
    var o = j.call(arguments, 1),
      ...
      if (this instanceof i) {
        ...
        var t = new e(),
            e = r.apply(t, o.concat(j.call(arguments)));
        return Object(e) === e ? e : t;
      }

      return r.apply(n, o.concat(j.call(arguments)));
    };

    return i;
  });
  var A, L, $;
  A = ["fontface", "touch", "csstransforms3d", "generatedcontent"], b = ['@font-face {font-family:"font";src:url("https://")}', ["@media (", y.join("touch-enabled),("), p, ")", "{#touch{top:9px;position:absolute}}"].join(""), ["@media (", y.join("transform-3d),("), p, ")", "{#csstransforms3d{left:9px;position:absolute;height:3px;}}"].join(""), ['#generatedcontent:after{content:"', g, '";visibility:hidden}'].join("")].join(""), o(b, function (e, t) {
    ...
    d.touch = "ontouchstart" in i || i.DocumentTouch && l instanceof DocumentTouch || 9 === (o.touch && o.touch.offsetTop), d.csstransforms3d = 9 === (o.csstransforms3d && o.csstransforms3d.offsetLeft) && 3 === o.csstransforms3d.offsetHeight, d.generatedcontent = 1 <= (o.generatedcontent && o.generatedcontent.offsetHeight), d.fontface = /src/i.test(n) && 0 === n.indexOf(t.split(" ")[0]);
  }, L = A.length, A);

  for ($ in S.flexbox = function () {
    return r("flexOrder");
  }, S.canvas = function () {
    var e = l.createElement("canvas");
    return !!e.getContext && !!e.getContext("2d");
  }, S.canvastext = function () {
    return !!d.canvas && !!c(l.createElement("canvas").getContext("2d").fillText, "function");
  }, S.webgl = function () {
    try {
      var e = l.createElement("canvas"),
    ...
    for (var e = -1, t = x.length; ++e < t;) if (i[x[e] + "WebSocket"]) return !0;

    return "WebSocket" in i;
  }, S.rgba = function () {
    return t("background-color:rgba(150,255,150,.5)"), n(m.backgroundColor, "rgba");
  }, S.hsla = function () {
    return t("background-color:hsla(120,40%,100%,.5)"), n(m.backgroundColor, "rgba") || n(m.backgroundColor, "hsla");
  }, S.multiplebgs = function () {
    return t("background:url(https://),url(https://),red url(https://)"), /(url\s*\(.*?){3}/.test(m.background);
    ...
    return t(y.join("opacity:.55;") + ""), /^0.55$/.test(m.opacity);
    ...
    return t((e + "-webkit- ".split(" ").join("gradient(linear,left top,right bottom,from(#9f9),to(white));" + e) + y.join("linear-gradient(left top,#9f9, white);" + e)).slice(0, -e.length)), n(m.backgroundImage, "gradient");
    ...
    var e = !!r("perspective");
    return e && "webkitPerspective" in f.style && (e = d.csstransforms3d), e;
    ...
    return !!l.createElementNS && !!l.createElementNS(E, "svg").createSVGRect;
  }, S.inlinesvg = function () {
    var e = l.createElement("div");
    return e.innerHTML = "<svg/>", (e.firstChild && e.firstChild.namespaceURI) == E;
  }, S.smil = function () {
    return !!l.createElementNS && /SVGAnimate/.test(v.call(l.createElementNS(E, "animate")));
  }, S.svgclippaths = function () {
    return !!l.createElementNS && /SVGClipPath/.test(v.call(l.createElementNS(E, "clipPath")));
  }, S) P(S, $) && (e = $.toLowerCase(), d[e] = S[$](), T.push((d[e] ? "" : "no-") + e));

  return d.input || (d.input = function (e) {
    for (var t = 0, n = e.length; t < n; t++) k[e[t]] = e[t] in h;

    return k.list && (k.list = !!l.createElement("datalist") && !!i.HTMLDataListElement), k;
  }("autocomplete autofocus list placeholder max min multiple pattern required step".split(" ")), d.inputtypes = function (e) {
    for (var t, n, r, o = 0, i = e.length; o < i; o++) h.setAttribute("type", n = e[o]), (t = "text" !== h.type) && (h.value = g, h.style.cssText = "position:absolute;visibility:hidden;", /^range$/.test(n) && h.style.WebkitAppearance !== a ? (f.appendChild(h), t = (r = l.defaultView).getComputedStyle && "textfield" !== r.getComputedStyle(h, null).WebkitAppearance && 0 !== h.offsetHeight, f.removeChild(h)) : /^(search|tel)$/.test(n) || (/^(url|email)$/.test(n) ? t = h.checkValidity && !1 === h.checkValidity() : /^color$/.test(n) ? (f.appendChild(h), f.offsetWidth, t = h.value != g, f.removeChild(h)) : t = h.value != g)), w[e[o]] = !!t;

    return w;
  }("search tel url email datetime date month week time datetime-local number range color".split(" "))), d.addTest = function (e, t) {
    if ("object" == typeof e) for (var n in e) P(e, n) && d.addTest(n, e[n]);else {
      if (e = e.toLowerCase(), d[e] !== a) return d;
      t = "function" == typeof t ? t() : t, f.className += " " + (t ? "" : "no-") + e, d[e] = t;
    }
    return d;
  }, t(""), h = null, function (e, t) {
    function l(e) {
    ...
    e.html5 = p, n(t);
  }(this, l), d._version = "2.5.2", d._prefixes = y, d._domPrefixes = C, d._cssomPrefixes = x, d.mq = function (e) {
    var t,
        n = i.matchMedia || i.msMatchMedia;
    return n ? n(e).matches : (o("@media " + e + " { #" + p + " { position: absolute; } }", function (e) {
      t = "absolute" == (i.getComputedStyle ? getComputedStyle(e, null) : e.currentStyle).position;
    }), t);
  }, d.hasEvent = N, d.testProp = function (e) {
    return s([e]);
  }, d.testAllProps = r, d.testStyles = o, d.prefixed = function (e, t, n) {
    return t ? r(e, t, n) : r(e, "pfx");
  }, f.className = f.className.replace(/(^|\s)no-js(\s|$)/, "$1$2") + (" js " + T.join(" ")), d;
  ...
  function t(e, t, n, r, o) {
    return x = 0, t = t || "j", m(e) ? (a = "c" == t ? w : S, c = e, s = t, t = this.i++, n = n, r = r, o = (o = o) || T.errorTimeout, l = {}, d = u = 0, f = {
      t: s,
      s: c,
      e: n,
      a: r,
